            ...
            <Col lg={8} xl={7}>
              <div className="iaf-hero-content">
                ...
                <p className="iaf-hero-description">
                  A unified digital platform for monitoring aircraft, equipment,
                  maintenance assets, logistics and future aviation platforms
                  across the air-power ecosystem.
                </p>

                {/* ACTION BUTTONS */}
                <div className="iaf-hero-actions">
                  <Button as={Link} to="/dashboard" className="iaf-primary-btn">
                    ACCESS INVENTORY
                    <FaArrowRight />
                  </Button>
            ...
            <Col lg={4} xl={5}>
              <div className="iaf-command-panel">
                ...
                <div className="command-panel-main">
                  <span className="panel-kicker">AIR ASSET READINESS</span>
                  ...
                  <small>OPERATIONAL READINESS INDEX</small>
                </div>
      ...
      <section className="iaf-introduction">
        <Container>
          <div className="iaf-section-heading">
            <div>
              <span className="section-kicker">DIGITAL AIR COMMAND</span>
            ...
            <p>
              Designed to provide a centralized operational view of aircraft
              platforms, inventory assets, maintenance status and strategic
          ...
          <Row className="g-4">
            ...
            <Col md={6} lg={3}>
              <Card className="iaf-feature-card">
                ...
                <p>
                  Monitor fighter aircraft, transport platforms, helicopters and
                  support assets from one interface.
                </p>

                <Link to="/fighters" className="feature-link">
                  VIEW FLEET
                  <FaChevronRight />
                </Link>
              </Card>
            ...
            <Col md={6} lg={3}>
              <Card className="iaf-feature-card">
                ...
                <p>
                  Track maintenance cycles, service schedules, aircraft
                  availability and technical readiness.
                </p>

                <Link to="/maintenance" className="feature-link">
                  MAINTENANCE DATA
                  <FaChevronRight />
                </Link>
              </Card>
            ...
            <Col md={6} lg={3}>
              <Card className="iaf-feature-card">
                ...
                <p>
                  Transform inventory and operational data into actionable
                  readiness and performance insights.
                </p>
      ...
      <section className="iaf-statistics">
        <Container>
          <div className="statistics-header">
            ...
            <p>
              Strategic visibility across the aviation inventory management
              ecosystem.
            </p>
          </div>
          ...
          <Row className="align-items-center g-5">
            ...
            <Col lg={6}>
              <div className="future-visual">
                <div className="future-image-frame">
                  <img src={heroImage} alt="Future Indian Air Force aircraft" />
                </div>
            ...
            <Col lg={6}>
              <div className="future-content">
                ...
                <p>
                  Explore next-generation aviation platforms and emerging
                  technologies shaping the future of Indian air power.
                </p>
                ...
                <div className="future-points">
                  <div>
                    ...
                    <div>
                      ...
                      <span>Next-generation fighter and combat aircraft.</span>
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div>
                      ...
                      <span>Integrated command, control and intelligence.</span>
                    </div>
                  </div>
      ...
      <section className="iaf-final-cta">
        <Container>
          <div className="cta-content">
            ...
            <Button as={Link} to="/inventory" className="iaf-primary-btn">
        ...
        <Container>
          <div className="footer-inner">
            <div className="footer-brand">
              <img src={iafLogo} alt="Indian Air Force Logo" />
